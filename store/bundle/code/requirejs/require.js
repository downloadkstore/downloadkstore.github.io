...
!function(global, setTimeout) {
    ...
    function newContext(e) {
        ...
        function i(e, i, r) {
            var n, o, a, s, u, c, d, p, f, l, h, m = i && i.split("/"), g = y.map, v = g && g["*"];
            if (e && (e = e.split("/"),
            c = e.length - 1,
            ...
            r && g && (m || v)) {
                ...
                e: for (a = o.length; a > 0; a -= 1) {
                    if (u = o.slice(0, a).join("/"),
                    m)
                        for (s = m.length; s > 0; s -= 1)
                            if ((n = getOwn(g, m.slice(0, s).join("/"))) && (n = getOwn(n, u))) {
                                d = n,
                                p = a;
                                break e
                            }
                    !f && v && getOwn(v, u) && (f = getOwn(v, u),
                    l = a)
                }
                !d && f && (d = f,
                p = l),
        ...
        function a(e, t, r, n) {
            ...
            e && (d ? h = s && s.normalize ? s.normalize(e, function(e) {
                return i(e, p, n)
            }) : -1 === e.indexOf("!") ? i(e, p, n) : e : (h = i(e, p, n),
            c = o(h),
            d = c[0],
            h = c[1],
            r = !0,
        ...
        b.prototype = {
            ...
            callPlugin: function() {
                ...
                u(r, "defined", bind(this, function(r) {
                    ...
                    void ((d = getOwn(S, o.id)) && (this.depMaps.push(o),
            ...
            makeRequire: function(t, n) {
                ...
                mixin(o, {
                    ...
                    toUrl: function(e) {
                        ...
                        return -1 !== n && (!a || n > 1) && (r = e.substring(n, e.length),
                        e = e.substring(0, n)),
