              ...
              , e = function(a, b, c) {
                ...
                if (b in a) {
                    ...
                    a[b] = function() {
                        ...
                        "assert" === b ? a[0] === !1 && (h = "Assertion failed: " + (d.safeJoin(a.slice(1), " ") || "console.assert"),
        ...
        3: [function(a, b, c) {
            (function(c) {
                ...
                function f() {
                    ...
                    this.j = {},
                    this.k = {
                        release: K.SENTRY_RELEASE && K.SENTRY_RELEASE.id,
                        logger: "javascript",
                        ignoreErrors: [],
                        ignoreUrls: [],
                        whitelistUrls: [],
                ...
                var g = a(6)
                  ...
                  , E = j.fill
                  , F = j.supportsFetch
                  , G = j.supportsReferrerPolicy
                  , H = a(2).wrapMethod
                  , I = "source protocol user pass host port path".split(" ")
                  , J = /^(?:(\w+):)?\/\/(?:(\w+)(:\w+)?@)?([\w\.-]+)(?::(\d+))?(\/.*)/
                  , K = "undefined" != typeof window ? window : "undefined" != typeof c ? c : "undefined" != typeof self ? self : {}
                  , L = K.document
                  , M = K.navigator;
                f.prototype = {
                    VERSION: "3.22.4",
                    ...
                    config: function(a, b) {
                        ...
                        d.ignoreErrors = x(d.ignoreErrors),
                        d.ignoreUrls = !!d.ignoreUrls.length && x(d.ignoreUrls),
                        d.whitelistUrls = !!d.whitelistUrls.length && x(d.whitelistUrls),
                        d.includePaths = x(d.includePaths),
                        ...
                        var e = {
                          ...
                          , f = d.autoBreadcrumbs;
                        "[object Object]" === {}.toString.call(f) ? f = t(e, f) : f !== !1 && (f = e),
                        d.autoBreadcrumbs = f;
                        var h = {
                            tryCatch: !0
                        }
                          , i = d.instrument;
                        return "[object Object]" === {}.toString.call(i) ? i = t(h, i) : i !== !1 && (i = h),
                        d.instrument = i,
                    ...
                    install: function() {
                        ...
                        a.B(),
                        a.k.instrument && a.k.instrument.tryCatch && a.C(),
                        a.k.autoBreadcrumbs && a.D(),
                        a.E(),
                        a.n = !0),
                    ...
                    setDSN: function(a) {
                        ...
                        b.G = a,
                        b.h = c.user,
                        b.H = c.pass && c.pass.substr(1),
                        b.i = c.path.substr(d + 1),
                        b.g = b.I(c),
                        b.J = b.g + "/" + e + "api/" + b.i + "/store/",
                        this.y()
                    },
                    ...
                    captureException: function(a, b) {
                        ...
                        var c = !k(a)
                          ...
                          , e = m(a) && !a.error;
                        if (c && d || e)
                            return this.captureMessage(a, t(b, {
                                stacktrace: !0,
                    ...
                    setExtraContext: function(a) {
                        return this.U("extra", a),
                        this
                    },
                    setTagsContext: function(a) {
                        return this.U("tags", a),
                        this
                    },
                    ...
                    V: function(a, b) {
                        ...
                        if (this.b) {
                            ...
                            L.createEvent ? (c = L.createEvent("HTMLEvents"),
                            c.initEvent(a, !0, !0)) : (c = L.createEventObject(),
                            c.eventType = a);
                            for (d in b)
                                w(b, d) && (c[d] = b[d]);
                            if (L.createEvent)
                                ...
                                try {
                                    L.fireEvent("on" + c.eventType.toLowerCase(), c)
                                } catch (e) {}
                        }
                    },
                    W: function(a) {
                    ...
                    C: function() {
                        function a(a) {
                            return function(b, d) {
                                for (var e = new Array(arguments.length), f = 0; f < e.length; ++f)
                                    e[f] = arguments[f];
                                var g = e[0];
                                return o(g) && (e[0] = c.wrap(g)),
                                a.apply ? a.apply(this, e) : a(e[0], e[1])
                            }
                        }
                        function b(a) {
                            var b = K[a] && K[a].prototype;
                            b && b.hasOwnProperty && b.hasOwnProperty("addEventListener") && (E(b, "addEventListener", function(b) {
                                return function(d, f, g, h) {
                                    ...
                                    var j, k, l;
                                    return e && e.dom && ("EventTarget" === a || "Node" === a) && (k = c.W("click"),
                                    l = c.Y(),
                                    j = function(a) {
                                        if (a) {
                                            var b;
                            ...
                            E(b, "removeEventListener", function(a) {
                        ...
                        E(K, "setTimeout", a, d),
                        E(K, "setInterval", a, d),
                        K.requestAnimationFrame && E(K, "requestAnimationFrame", function(a) {
                            return function(b) {
                                return a(c.wrap(b))
                            }
                        }, d);
                    ...
                    D: function() {
                        ...
                        c.xhr && F() && E(K, "fetch", function(a) {
                            return function() {
                                for (var c = new Array(arguments.length), d = 0; d < c.length; ++d)
                                    c[d] = arguments[d];
                                var e, f = c[0], g = "GET";
                                if ("string" == typeof f ? e = f : "Request"in K && f instanceof K.Request ? (e = f.url,
                                f.method && (g = f.method)) : e = "" + f,
                                e.indexOf(b.h) !== -1)
                        ...
                        c.dom && this.b && (L.addEventListener ? (L.addEventListener("click", b.W("click"), !1),
                        L.addEventListener("keypress", b.Y(), !1)) : (L.attachEvent("onclick", b.W("click")),
                        L.attachEvent("onkeypress", b.Y())));
                        var f = K.chrome
                          , g = f && f.app && f.app.runtime
                          , h = !g && K.history && history.pushState && history.replaceState;
                        if (c.location && h) {
                            var i = K.onpopstate;
                            ...
                            E(history, "pushState", j, d),
                            E(history, "replaceState", j, d)
                        }
                        if (c.console && "console"in K && console.log) {
                            var k = function(a, c) {
                                b.captureBreadcrumb({
                                    message: a,
                                    level: c.level,
                    ...
                    aa: function(a, b, c, d, e, f) {
                        ...
                        if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(b) && !this.k.ignoreErrors.test(g)) {
                            var h;
                            if (e && e.length ? (c = e[0].filename || c,
                            e.reverse(),
                            h = {
                                frames: e
                            }) : c && (h = {
                    ...
                    ca: function(a) {
                        ...
                        if (a.message && (a.message = u(a.message, b)),
                        a.exception) {
                            var c = a.exception.values[0];
                            c.value = u(c.value, b)
                        }
                        var d = a.request;
                        return d && (d.url && (d.url = u(d.url, this.k.maxUrlLength)),
                        d.Referer && (d.Referer = u(d.Referer, this.k.maxUrlLength))),
                        a.breadcrumbs && a.breadcrumbs.values && this.da(a.breadcrumbs),
                        a
                    },
                    da: function(a) {
                        for (var b, c, d, e = ["to", "from", "url"], f = 0; f < a.values.length; ++f)
                            if (c = a.values[f],
                            c.hasOwnProperty("data") && l(c.data) && !v(c.data)) {
                                d = t({}, c.data);
                                for (var g = 0; g < e.length; ++g)
                                    b = e[g],
                                    d.hasOwnProperty(b) && d[b] && (d[b] = u(d[b], this.k.maxUrlLength));
                                a.values[f].data = d
                            }
                    },
                    ea: function() {
                        if (this.c || this.b) {
                            var a = {};
                            return this.c && M.userAgent && (a.headers = {
                                "User-Agent": navigator.userAgent
                            }),
                            K.location && K.location.href && (a.url = K.location.href),
                            this.b && L.referrer && (a.headers || (a.headers = {}),
                            a.headers.Referer = L.referrer),
                            a
                        }
                    },
                    y: function() {
                    ...
                    ja: function(a) {
                        if (!this.ha()) {
                            ...
                            if (400 === b || 401 === b || 429 === b) {
                                var c;
                                try {
                                    c = F() ? a.headers.get("Retry-After") : a.getResponseHeader("Retry-After"),
                                    c = 1e3 * parseInt(c, 10)
                                } catch (e) {}
                                this.fa = c ? c : 2 * this.fa || 1e3,
                                this.ga = d()
                            }
                        }
                    },
                    T: function(a) {
                        ...
                        a = t(c, a),
                        a.tags = t(t({}, this.j.tags), a.tags),
                        a.extra = t(t({}, this.j.extra), a.extra),
                        a.extra["session:duration"] = d() - this.s,
                        this.u && this.u.length > 0 && (a.breadcrumbs = {
                        ...
                        a && !r(a) && (!o(b.shouldSendCallback) || b.shouldSendCallback(a)))
                    ...
                    ka: function(a, b) {
                        ...
                        if (this.isSetup()) {
                            if (a = this.ca(a),
                            !this.k.allowDuplicates && this.ia(a))
                                return void this.z("warn", "Raven dropped repeat event: ", a);
                            this.f = a.event_id || (a.event_id = this.la()),
                            this.e = a,
                    ...
                    ma: function(a) {
                        var b = a.url + "?" + y(a.auth)
                          , c = null
                          , d = {};
                        if (a.options.headers && (c = this.na(a.options.headers)),
                        a.options.fetchParameters && (d = this.na(a.options.fetchParameters)),
                        F()) {
                            d.body = h(a.data);
                            var e = t({}, this.l)
                              , f = t(e, d);
                            return c && (f.headers = c),
                            K.fetch(b, f).then(function(b) {
                                if (b.ok)
                        ...
                        var g = K.XMLHttpRequest && new K.XMLHttpRequest;
                        if (g) {
            ...
            (function(a) {
                ...
                function u(a) {
                    for (var b, c = [], d = 0, e = a.length; d < e; d++)
                        b = a[d],
                        i(b) ? c.push(b.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : b && b.source && c.push(b.source);
                ...
                function y(a) {
                    for (var b, c = 5, d = 80, e = [], f = 0, g = 0, h = " > ", i = h.length; a && f++ < c && (b = z(a),
                ...
                function C(a, b) {
                    return !A(a, b) && (a = a.values[0],
                    b = b.values[0],
                    a.type === b.type && a.value === b.value && (!B(a.stacktrace, b.stacktrace) && D(a.stacktrace, b.stacktrace)))
                }
                function D(a, b) {
                    if (A(a, b))
                        return !1;
                ...
                var G = "undefined" != typeof window ? window : "undefined" != typeof a ? a : "undefined" != typeof self ? self : {};
                b.exports = {
                    isObject: c,
                    isError: d,
                    isErrorEvent: e,
            ...
            (function(c) {
                ...
                f.report = function() {
                    ...
                    function l(a, b, c, g, h) {
                        ...
                        if (v)
                            f.computeStackTrace.augmentStackTraceWithInitialElement(v, b, c, n),
                            o();
                        else if (m && e.isError(m))
                            l = f.computeStackTrace(m),
                            k(l, !0);
                        else {
                            var p, r = {
                                url: b,
                        ...
                        if ("undefined" != typeof a.stack && a.stack) {
                            ...
                            0), o = l.length; n < o; ++n) {
                                if (c = f.exec(l[n])) {
                                    ...
                                    q && (b = j.exec(c[3])) ? (c[3] = b[1],
                                    c[4] = b[2],
                                    c[5] = null) : 0 !== n || c[5] || "undefined" == typeof a.columnNumber || (m[0].column = a.columnNumber + 1),
                                    e = {
                                        url: c[3],
                                        func: c[1] || i,
                                        args: c[2] ? c[2].split(",") : [],
