function __cons(t, a) {
    return eval("new t(" + Array.prototype.map.call(a, function(t, e) {
        return "a[" + e + "]"
    }).join(",") + ")")
}
    ...
    function() {
        ...
        n(p, "next", function() {
            ...
            for (var r = t["[[Map]]"], n = t["[[MapNextIndex]]"], i = t["[[MapIterationKind]]"], u = r["[[MapData]]"]; n < u.keys.length; ) {
                ...
                o(t, "[[MapNextIndex]]", n),
                c.key !== nt)
                    return "key" === i ? T(c.key, !1) : "value" === i ? T(c.value, !1) : T([c.key, c.value], !1)
            }
            return T(C, !0)
        }),
        n(p, ft, "Map Iterator")
    ...
    function() {
        ...
        n(p, "next", function() {
            ...
            for (var r = t["[[IteratedSet]]"], n = t["[[SetNextIndex]]"], i = t["[[SetIterationKind]]"], u = r["[[SetData]]"]; n < u.length; ) {
                ...
                o(t, "[[SetNextIndex]]", n),
                c !== nt)
                    return "key+value" === i ? T([c, c], !1) : T(c, !1)
            }
            return T(C, !0)
        }),
        n(p, ft, "Set Iterator")
    ...
    function() {
        ...
        function u() {
            var t = function(e) {
                ...
                return l(u) ? (O("PromiseJobs", b, [r, e, u]),
                C) : c(r, e)
            };
            return t
        }
        ...
        n(E.prototype, "then", function(t, e) {
            ...
            r["[[PromiseRejectReactions]]"].push(i)) : "fulfilled" === r["[[PromiseState]]"] ? O("PromiseJobs", m, [o, r["[[PromiseResult]]"]]) : "rejected" === r["[[PromiseState]]"] && O("PromiseJobs", m, [i, r["[[PromiseResult]]"]]),
            n["[[Promise]]"]
        }),
...
function(t) {
    ...
    if ("window"in t && "document"in t) {
        ...
        "previousElementSibling"in document.documentElement || e("previousElementSibling", function() {
            for (var t = this.previousSibling; t && t.nodeType !== Node.ELEMENT_NODE; )
                t = t.previousSibling;
            return t
        }),
        "nextElementSibling"in document.documentElement || e("nextElementSibling", function() {
        ...
        r(t.Document || t.HTMLDocument, o),
        r(t.DocumentFragment, o),
        r(t.Element, o),
        "firstElementChild"in document.documentElement || e("firstElementChild", function() {
            for (var t = this.children, e = 0, r = t.length; e < r; ++e) {
                var n = t[e];
        ...
        "lastElementChild"in document.documentElement || e("lastElementChild", function() {
        ...
        "childElementCount"in document.documentElement || e("childElementCount", function() {
            for (var t = 0, e = this.children, r = 0, n = e.length; r < n; ++r)
                e[r].nodeType === Node.ELEMENT_NODE && ++t;
            return t
        });
        var i = {
            before: function() {
                var t = [].slice.call(arguments)
                  , e = this.parentNode;
                if (e) {
                    for (var r = this.previousSibling; -1 !== t.indexOf(r); )
                        r = r.previousSibling;
                    var o = n(t);
                    e.insertBefore(o, r ? r.nextSibling : e.firstChild)
                }
            },
            after: function() {
                var t = [].slice.call(arguments)
                  , e = this.parentNode;
                if (e) {
                    for (var r = this.nextSibling; -1 !== t.indexOf(r); )
                        r = r.nextSibling;
                    var o = n(t);
                    e.insertBefore(o, r)
                }
            ...
            replaceWith: function() {
                ...
                if (e) {
                    for (var r = this.nextSibling; -1 !== t.indexOf(r); )
                        r = r.nextSibling;
                    var o = n(t);
                    this.parentNode === e ? e.replaceChild(o, this) : e.insertBefore(o, r)
                }
            },
            remove: function() {
